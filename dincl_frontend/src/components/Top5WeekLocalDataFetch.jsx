...
const Top5WeeklyDataFetchComponent = () => {
  ...
  useEffect(() => {
    ...
    const countApiUrl = 'http://127.0.0.1:8000/api/v1/top5_weekly_count?format=json'; // New API endpoint for fetching count
  ...
  return (
    <div className="component">
      {!showPopup ? (
        <div>
          <button onClick={handleShowPopup}>TOP 5 województw w ostatnim tygodniu</button>
